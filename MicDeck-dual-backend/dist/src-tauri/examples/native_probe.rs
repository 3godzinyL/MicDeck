...
fn main() -> Result<(), String> {
    ...
    unsafe {
        ...
        println!(
            "dll={}\nprotocol={} connected={} state={} pid={} mic={:.3} mic_in={:.3} mic_out={:.3} voice={:.3} system={:.3} system_in={:.3} system_out={:.3} mix={:.3} mic_gain={:.3} system_gain={:.3} underruns={} overruns={} dropped={} latency_ms={:.2} sessions={} error={}",
            dll_path.display(),
